...
function hoverEnd(e:React.MouseEvent<HTMLDivElement, MouseEvent>) {
    ...
    var glow = card.querySelector(".special-glow");
    card_container.style.transform = `scale(1) rotateX(0) rotateY(0)`;
}
    ...
    return(
        <div className="w-screen h-48 bg-gray-800">
            <div className="backdrop-blur-lg rounded-md border border-blue-700 p-2 ml-auto mr-auto max-w-2xl w-[56rem] bg-blue-900 h-[100%] opacity-100 relative top-[-40px] text-gray-300 self-center justify-self-center place-self-center font-mono">
                ...
                <p>
                <span>
                    <a href="https://github.com/genericallynamed">{"github"}</a> <a href="https://www.linkedin.com/in/alexshandilis/">{"linkedin"}</a> <a href="https://github.com/GenericallyNamed/dev-portfolio-2">{"source-code"}</a> <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">{"funny"}</a>
                </span>
                </p>
            </div>
        </div>
